...
export const LANG_KO = {
  ...
  view: {
    ...
    readiness: {
      title: "Paper Experiment 상태",
      notReady: "모의투자 실험 BLOCKED",
      ready: "모의투자 실험 GO",
      paperNetwork: "시세 API 연결",
      paperOrderEnabled: "Paper 주문 루프",
      paperOrders: "주문 증거",
      observation: "관찰 증거",
      operational: "최종 운영 준비",
      orderGate: "주문 게이트",
      blockers: "차단 사유",
      serviceVisibilityWarning: "목표는 최종 운영 ready가 아니라 KIS 모의투자 paper experiment입니다.",
