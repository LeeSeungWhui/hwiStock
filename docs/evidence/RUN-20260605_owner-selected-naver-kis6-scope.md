...
- UNIT-013 KIS paper-read signal input scope is exactly six inputs:
  ...
  6. REST program-trading aggregate status where paper-supported.
...
Missing NAVER config or missing KIS paper-read proof produces safe-block evidence,
...
No KIS broker/API call, NAVER API call, OpenDART call, DeepSeek call, live
