...
This evidence does **not** authorize operational trading, brokerage
integration, unscoped KIS/broker network calls, AI provider network calls,
credential storage, adapter/account-affecting order placement, public/LAN dashboard exposure,
