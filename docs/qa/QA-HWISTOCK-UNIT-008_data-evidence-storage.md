...
operator-selected operation observation evidence.
...
- operator-selected operation observation manifest linkage
...
| QA-006 | P0 | evidence | Inspect operation observation evidence manifest | Each observation day can link source artifacts, AI outputs, candidates, trades, PnL, morning report, and daily close | evidence review |
...
- sample adapter-day evidence manifest
- redaction review
