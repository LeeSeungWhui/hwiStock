...
| QA-003 | P0 | docs | Review KRX/NXT/SOR-related API behavior | KRX/NXT/SOR fields are documented; paper/mock mode rejects NXT broker branches, future live mode starts `krx_only` and requires separate approval/Ready-Set for NXT, and SOR operation behavior remains disabled/fallback | `RUN-20260602_unit-009-kis-api-portal-verification-set.md`; `docs/sources/HWISTOCK-KIS-API-CAPABILITY-MATRIX.md`; `docs/evidence/RUN-20260604_unit-009-go-check-rebaseline.md` |
