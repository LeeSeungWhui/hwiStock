...
| AC-05 | P0 | Dashboard is local-only by default | Dashboard/API bind `127.0.0.1`; remote access is SSH tunnel or Chrome Remote Desktop | config/network review | QA-005 |
