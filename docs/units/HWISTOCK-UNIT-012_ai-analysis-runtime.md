...
| AC-04a | P0 | Flash timer does not run off-hours in paper mode | The installed paper/mock Flash timer is scoped to the KRX decision window (`09:00-14:50 KST` every 10 minutes on weekdays) and does not wake every 10 minutes overnight. |
