"""
HWISTOCK-UNIT-003 market intelligence ingestion.
    ...
    if enable_network:
        ...
        source_results.extend(
            [
                ...
                {"source_id": "public_news_rss_search", "status": "skipped_network_disabled"},
            ]
        )
...
def main(argv: Optional[Sequence[str]] = None) -> int:
    ...
    parser.add_argument("--no-public-rss", action="store_true", help="Skip no-key public RSS news collection")
    ...
    result = runCollectorOnce(
        ...
        include_public_rss=not args.no_public_rss,
    )
    print(json.dumps(result["health"], ensure_ascii=False, indent=2, sort_keys=True))
    return 0
